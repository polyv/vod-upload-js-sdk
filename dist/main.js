...
var _promise = _interopRequireDefault(__webpack_require__(1));

var _pubsub = _interopRequireDefault(__webpack_require__(6));
...
/*#__PURE__*/
function (_PubSub) {
  _inheritsLoose(PlvVideoUpload, _PubSub);
...
Promise = Promise ? __webpack_require__(3) : __webpack_require__(5);
/**
 * 指定当前promise被解决后的操作。
 * @method then
 * @for Promise
 ...
 * @ignore
 */
var base = __webpack_require__(4); // 输出错误日志（兼容旧浏览器）
 ...
 * @category Infrastructure
 */
var EventArg = __webpack_require__(7);
/**
 * 事件驱动机制。
 * @class PubSub
 * @exports
...
var _aliyunOssSdk = _interopRequireDefault(__webpack_require__(9));
...
/*#__PURE__*/
function (_PubSub) {
  _inheritsLoose(UploadManager, _PubSub);
  ...
  /*#__PURE__*/
  function () {
    var _updateProgress2 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(progress, checkpoint) {
...
var _ajax = _interopRequireDefault(__webpack_require__(11));
...
var timespan = __webpack_require__(12);
